...
const OpInfo op_info_table[kOpCount] = {
  ...
  ROW(IsNan        , IsNan        , 1, 0, 0, 1, LTR | F(Condition)                       , "is_nan"         ),
  ROW(IsInf        , IsInf        , 1, 0, 0, 1, LTR | F(Condition)                       , "is_inf"         ),
  ROW(IsFinite     , IsFinite     , 1, 0, 0, 1, LTR | F(Condition)                       , "is_finite"      ),
  ROW(SignBit      , SignBit      , 1, 0, 0, 1, LTR | F(Condition)                       , "sign_bit"       ),
  ...
  ROW(RoundEven    , RoundEven    , 1, 0, 0, 1, LTR | F(Rounding)                        , "round_even"     ),
  ROW(RoundHalfAway, RoundHalfAway, 1, 0, 0, 1, LTR | F(Rounding)                        , "round_half_away"),
  ROW(RoundHalfUp  , RoundHalfUp  , 1, 0, 0, 1, LTR | F(Rounding)                        , "round_half_up"  ),
  ...
  ROW(CopySign     , CopySign     , 2, 0, 0, 1, LTR | 0                                  , "copy_sign"      )
};
#undef F
#undef RTL
#undef LTR
